package com.iAttend.controller;

import com.iAttend.entity.ImageModel;
import com.iAttend.service.ImageService;
...
public class ImageController {
    ...
    public ModelAndView home(){
        ...
        List<ImageModel> imageList = imageService.getAllImages();
    ...
    public String addImagePost(HttpServletRequest request, @RequestParam("image") MultipartFile file,
                               ...
                               @RequestParam("id") int id) throws IOException, SQLException
    {
